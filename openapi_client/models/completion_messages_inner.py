...
class CompletionMessagesInner(BaseModel):
    """
    CompletionMessagesInner
    """ # noqa: E501
    role: Optional[StrictStr] = Field(default=None, description="The role of the message's author.")
    ...
    def role_validate_enum(cls, value):
        ...
        if value not in set(['system', 'assistant', 'user']):
            raise ValueError("must be one of enum values ('system', 'assistant', 'user')")
        return value
