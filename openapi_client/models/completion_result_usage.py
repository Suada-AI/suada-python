...
class CompletionResultUsage(BaseModel):
    """
    CompletionResultUsage
    """ # noqa: E501
    prompt_tokens: Optional[Union[StrictFloat, StrictInt]] = None
    completion_tokens: Optional[Union[StrictFloat, StrictInt]] = None
    total_tokens: Optional[Union[StrictFloat, StrictInt]] = None
