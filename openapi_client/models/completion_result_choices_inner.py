...
class CompletionResultChoicesInner(BaseModel):
    """
    CompletionResultChoicesInner
    """ # noqa: E501
    index: Optional[Union[StrictFloat, StrictInt]] = None
    message: Optional[CompletionResultChoicesInnerMessage] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "index": obj.get("index"),
            "message": CompletionResultChoicesInnerMessage.from_dict(obj["message"]) if obj.get("message") is not None else None,
